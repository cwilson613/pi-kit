...
Migration of direct operator, extension, host-effect, and privileged internal compatibility paths remains later Slice-3 work. Reactive path grants and extension HostAction approval can only narrow the upstream lease decision.
