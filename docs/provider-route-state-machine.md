...
dependencies: []
related: []
openspec_change: provider-route-state-machine
---
...
### Login attempts are stateful with terminal outcomes

**Status:** proposed

**Rationale:** 

### Fallback is opt-in; default is explicit failure

**Status:** accepted

**Rationale:** 

### Daemon scope deferred to omegon-quartus auspex workstream

**Status:** accepted

**Rationale:** 

### All model-changing surfaces are controller transitions

**Status:** accepted

**Rationale:** 

### CredentialLedger re-probes, never caches
